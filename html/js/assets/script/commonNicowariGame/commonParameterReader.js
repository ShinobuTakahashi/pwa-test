...
/** 特定のシーンを判定する文字列 */
const INITIAL_SCENE_STRING = "game";
/** 起動方法の放送者プレイを判定する文字列 */
const LAUNCH_TYPE_SELF_STRING = "self";
/** 起動方法の抽選されたユーザーがプレイを判定する文字列 */
const LAUNCH_TYPE_LOTTERY_STRING = "lottery";
/** 起動方法のみんなでプレイを判定する文字列 */
const LAUNCH_TYPE_RANKING_STRING = "ranking";
/**
 * 共通パラメータの読み込みクラス
 * 省略されたパラメータ項目の補完などを行う
 */
class CommonParameterReader {
    /**
     * 起動パラメータから対応するメンバ変数を設定する
     * @param {RireGameParameters} parameters 起動パラメータ
     */
    static read(parameters) {
        this.initialScene = "";
