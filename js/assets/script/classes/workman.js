window.gLocalAssetContainer["workman"] = function(g) { (function(exports, require, module, __filename, __dirname) {
"use strict";
...
class Workman {
    ...
    update() {
        if (this.flgAttack) { // 攻撃中
            ...
            if (this.cntStop > define_1.define.ATTCK_STOP_TIME) { // リロード完了
                this.flgAttack = false;
                this.cntStop = 0;
                // 通常腕に戻す
                this.changeHand(define_1.define.WKMAN_ATTACH_POS_NORMAL, asaInfo_1.AsaInfo.workman.anim.hand);
     ...
     */
    plusLevel() {
        if (this.level === define_1.define.BulletLevel.hammer) { // すでに最強なら処理しない
            return;
        }
        this.level += 1;
    }
     ...
     */
    changeHand(_attachPoint, _anime) {
